...
function format_namenode()
{
    ...
    DATA_DIR={{ pillar['hadoop']['hadoop_tmp_base_dir'] }}
...
function create_dirs()
{
    ...
    sudo -u hdfs hadoop fs -mkdir {{ pillar['hadoop']['mapred_system_dir'] }}
    sudo -u hdfs hadoop fs -chown mapred:hadoop {{ pillar['hadoop']['mapred_system_dir'] }}
}
